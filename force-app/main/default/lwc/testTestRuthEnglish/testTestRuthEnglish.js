...
import { OMNIDEF } from './testTestRuthEnglish_def.js';
import tmpl from './testTestRuthEnglish.html';
import tmpl_nds from './testTestRuthEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testTestRuthEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
