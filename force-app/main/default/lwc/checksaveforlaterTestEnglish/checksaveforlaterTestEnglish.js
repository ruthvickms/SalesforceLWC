...
import { OMNIDEF } from './checksaveforlaterTestEnglish_def.js';
import tmpl from './checksaveforlaterTestEnglish.html';
import tmpl_nds from './checksaveforlaterTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class checksaveforlaterTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
